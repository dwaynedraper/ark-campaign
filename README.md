...
1. Before you can run the solution, you will need to prepare the following
   ...
   * A valid/trusted wildcard certificate for `*.nextjs_sample_containers.localhost`
   * Hosts file entries for `nextjs_sample_containers.localhost`
