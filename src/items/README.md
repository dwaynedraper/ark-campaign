...
* `nextjs-sample-containers.module.json` contains developer-owned configuration items
  which are created by the JSS Styleguide sample.
* `nextjs-sample-containers-Content.module.json` contains content items which are
