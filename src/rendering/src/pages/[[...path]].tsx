...
import { RenderingType, SitecoreContext, ComponentPropsContext, EditingComponentPlaceholder } from '@sitecore-jss/sitecore-jss-nextjs';
  ...
  return (
    <ComponentPropsContext value={componentProps}>
      <SitecoreContext componentFactory={componentBuilder.getComponentFactory({ isEditing })} layoutData={layoutData}>
        ...
        */}
        {isComponentRendering ? <EditingComponentPlaceholder rendering={layoutData.sitecore.route} /> : <Layout layoutData={layoutData} headLinks={headLinks} />}
      </SitecoreContext>
