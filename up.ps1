...
if ($fastStart) {
    Write-Host "Starting Sitecore environment; skipping init'ers..." -ForegroundColor Green
    docker compose -f docker-compose.yml -f docker-compose.override.yml -f docker-compose.fast-start.yml up -d
}
else {
...
if ($ByPass) {
    dotnet sitecore login --cm https://cm.camp-compassion.localhost/ --auth https://id.camp-compassion.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}
else {
    dotnet sitecore login --cm https://cm.camp-compassion.localhost/ --auth https://id.camp-compassion.localhost/ --allow-write true
}
...
if (Test-Path .\src\items\contentRoot) {
    if ($pushSCS) {
...
Start-Process https://cm.camp-compassion.localhost/sitecore/
Start-Process https://www.camp-compassion.localhost/
